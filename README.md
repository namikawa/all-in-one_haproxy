...
(`/etc/chef/solo.rb`が配置されている前提。node.jsonはサンプル。)
    ...
    $ sudo chef-solo -j https://raw.githubusercontent.com/namikawa/all-in-one_haproxy/master/samples/solo/node.json -r https://dl.dropboxusercontent.com/u/684783/cookbooks/all-in-one_haproxy_20150805-1.tar.gz
